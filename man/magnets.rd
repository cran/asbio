...
\describe{
\item{\code{Score_1}}{Reported pain level before application of treatment.}   
\item{\code{Score_2}}{Reported pain level after application of treatment.}         
\item{\code{Active}}{Categorical variable indicating whether the device applied was active (magnet) or inactive (placebo).}        
  }
}
\source{Vallbona, C. et al  (1997)  Response of pain to static magnetic fields in post-polio patients, 
