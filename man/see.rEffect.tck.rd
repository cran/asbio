...
population of fertilizers \eqn{E(Y|A_i)} are normally distributed.  That is, it is possible to 
...
levels are homoscedastic. We weigh our evidence against the H\eqn{_0} of a non-zero population variance by estimating the 
variability among factor levels.  The more that yield varies with respect to nutrient treatments the more evidence we will have against H\eqn{_0}.  
}
\usage{
see.rEffect.tck()
}
