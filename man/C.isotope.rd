...
\description{
Atmospheric \eqn{\delta ^{14}}C (per mille) and CO\eqn{_2} (ppm) measurements for La Jolla Pier, California. Latitude: 32.9 Degrees N, Longitude: 117.3 Degrees W, Elevation: 10m; \eqn{\delta} \eqn{^{14}}C derived from flask air samples      
}
