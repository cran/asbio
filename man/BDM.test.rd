...
the Kruskal-Wallis test which utilizes the \emph{F}-distribution.  Along with being robust to non-normality and heteroscedasticity, 
calculations of exact \emph{P}-values using the Brunner-Dette-Munk method are not made more complex by tied values.  
