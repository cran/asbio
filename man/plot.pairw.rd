...
\author{
Ken Aho.  Letters for type 1 graphs obtained using the function \code{\link[multcompView]{multcompLetters}} which uses the algorithm of Peipho (2004).
}
\references{
...
\seealso{
\code{\link{pairw.anova}}, \code{\link{pairw.fried}}, \code{\link{pairw.kw}}, \code{\link{barplot}}, \code{\link{bplot}}, \code{\link[multcompView]{multcompLetters}}
}
\examples{
