...
\description{
The veterans administration studied the effect of AZT on AIDS symptoms for 338 veterans who just begining to express aids.  AZT treatment was withheld on a random component until helper T cells showed even greater depletion while the other group received the drug immediately.  The subjects were also classified by race.
}
\usage{data(aids)}
\format{
