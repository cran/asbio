...
\description{
The levels for a fixed factor are shown in rows, while the columns are levels for a random factor.  
...
the null hypothesis for the fixed factor is true.  That is, \eqn{\mu_{F1} = \mu_{F2} = \mu_{F3}}.  
However when we select a subset of random levels, this is obscured.  In fact, for any subset of random factor levels it appears as if there is evidence against H\eqn{_0}, 
