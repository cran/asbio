...
# Chapter 2
	tkadd(Ch2, "cascade", label = "Self-test questions", menu = questions2) #Names question menus
		...
		tkadd(questions2, "command", label = "Combinatorics", command = substitute(selftest.comb.tck())) # Ch 2 questions
...
# Chapter 5
	tkadd(Ch5, "cascade", label = "Self-test questions", menu = questions5) #Names question menus
		...
		tkadd(questions5, "command", label = "Confidence interval demonstration",
