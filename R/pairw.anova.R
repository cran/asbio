...
plot.pairw <- function(x, col = 1, lty = NULL, lwd = NULL, cap.length = 0.1, xlab = "", main = NULL, ...){
ci <- x$band
...
abline(h = b, col = "gray")
arrows(ci[,1], b, ci[,2], b, angle = 90, col = col, lty = lty, lwd = lwd, length = cap.length, code = 3)
