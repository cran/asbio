...
abline(v=0,lty=2)
mtext("Density", side = 2, line =.5,cex=.8)
mtext(expression(paste("E(Y|",A[i],")")), side = 1, line = .5,cex=.8)
...
abline(v=A1,lty=2,col="gray")
mtext("Density", side = 2, line = .5,cex=.8)
mtext(expression(paste("Yield given fertilizer 1; i.e. Y|",A[1])), side = 1, line = .5,cex=.8)
...
abline(v=A2,lty=2,col="gray")
mtext("Density", side = 2, line = .5,cex=.8)
mtext(expression(paste("Yield given fertilizer 2; i.e. Y|",A[2])), side = 1,  line = .5,cex=.8)
