...
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X < ",.(x),") = ",.(p))),bty="n",cex=legend.cex)
d<-round(dnorm(x,mean=mu,sd=sigma),digits)
if(show.d==TRUE)legend("topright",legend=c("",paste("f(",x,") = ",d)),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ N(",.(mu)," , ",.(sigma^2),")")),bty="n",cex=legend.cex)
}
...
if(show.p==TRUE)legend("topright",bty="n",cex=legend.cex,legend=bquote(paste("2*P(X > |",.(x),"|) = ",.(p))))
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ N(",.(mu)," , ",.(sigma^2),")")),bty="n",cex=legend.cex)
}
...
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(",.(from),"< X <",.(to),") = ",.(p))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ N(",.(mu)," , ",.(sigma^2),")")),bty="n",cex=legend.cex)
}
}
...
if(show.d==TRUE)legend("topright",legend=c("",paste("f(",x,") = ",d)),bty="n",cex=legend.cex)
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X < ",.(x),") = ",.(p))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ t(",.(nu),")")),bty="n",cex=legend.cex)
}
...
if(show.d==TRUE)legend("topright",legend=c("",paste("f(",x,") = ",d)),bty="n",cex=legend.cex)
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X < ",.(x),") = ",.(p))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("top",legend=bquote(paste("X ~ F(",.(nu1),",",.(nu2),")")),bty="n",cex=legend.cex,adj=0.5)
}
if(tail=="upper"){
...
if(show.p==TRUE)legend("topright",bty="n",cex=legend.cex,legend=bquote(paste("P(",.(qs[1]),"< X and X >",.(qs[2]),") = ",.(p))))
if(show.dist==TRUE)legend("top",legend=bquote(paste("X ~ F(",.(nu1),",",.(nu2),")")),bty="n",cex=legend.cex,adj=0.5)
}
if(tail=="middle"){
...
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X < ",.(x),") = ",.(p))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("top",legend=bquote(paste("X ~ ",chi^2,"(",.(nu),")")),bty="n",cex=legend.cex,adj=0.5)
}
...
shade.bin<-function(x=NULL,from=NULL,to=NULL,n=1,p=0.5,tail="X=x",show.p=TRUE,show.dist=TRUE,show.d=FALSE,legend.cex=.9,digits=5,...){
...
points(x,d,pch=19)
if(show.d==TRUE)legend("topright",legend=c("",paste("f(",x,") = ",d)),bty="n",cex=legend.cex)
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X = ",.(x),") = ",.(d))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ BIN(n = ",.(n),", p = ",.(p),")")),bty="n",cex=legend.cex)
}
...
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X"<=.(x),")=",.(pv))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ BIN(n = ",.(n),", p = ",.(p),")")),bty="n",cex=legend.cex)
}
...
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X"<=.(qs[1])," and X">=.(qs[2]),")=",.(pv))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ BIN(n = ",.(n),", p = ",.(p),")")),bty="n",cex=legend.cex)
}
...
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(",.(from)<="X",""<=.(to),")=",.(pv))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ BIN(n = ",.(n),", p = ",.(p),")")),bty="n",cex=legend.cex)
}
}
...
if(show.d==TRUE)legend("topright",legend=c("",paste("f(",x,") = ",d)),bty="n",cex=legend.cex)
if(show.p==TRUE)legend("topright",legend=bquote(paste("P(X = ",.(x),") = ",.(d))),bty="n",cex=legend.cex)
if(show.dist==TRUE)legend("topleft",legend=bquote(paste("X ~ POI(",.(lambda),")")),bty="n",cex=legend.cex)
}
